...
```bash
INIT=$(node "C:/Users/Antonio Amorim/Documents/GitHub/automecanico-pro/.claude/get-shit-done/bin/gsd-tools.cjs" init phase-op "${PHASE}")
...
Use the SPEC.md template from @C:/Users/Antonio Amorim/Documents/GitHub/automecanico-pro/.claude/get-shit-done/templates/spec.md.
