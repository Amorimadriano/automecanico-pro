...
```bash
INIT=$(node "C:/Users/Antonio Amorim/Documents/GitHub/automecanico-pro/.claude/get-shit-done/bin/gsd-tools.cjs" init ingest-docs)
...
```bash
node "C:/Users/Antonio Amorim/Documents/GitHub/automecanico-pro/.claude/get-shit-done/bin/gsd-tools.cjs" commit \
