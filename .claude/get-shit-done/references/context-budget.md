...
The keys live in `.claude/settings.json` (project) or `C:/Users/Antonio Amorim/Documents/GitHub/automecanico-pro/.claude/settings.json` (global) — **not** in `.planning/config.json`:
