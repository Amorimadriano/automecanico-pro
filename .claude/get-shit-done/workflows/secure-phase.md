...
```
Agent(
  prompt="Read C:/Users/Antonio Amorim/Documents/GitHub/automecanico-pro/.claude/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `C:/Users/Antonio Amorim/Documents/GitHub/automecanico-pro/.claude/get-shit-done/templates/SECURITY.md`
